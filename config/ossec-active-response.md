...
This is the active response configuration that automatically blocks an attacker's IP when rule 100100 (SSH brute force) fires. It's added to the Wazuh manager's main config file:
...
timeout_allowed is what makes the 120s auto-unblock possible.
